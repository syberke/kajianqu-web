...
export default function QuranSetoranClient({ mode, surahInfo, ayahStart, ayahEnd }: Props) {
  ...
  // Tahfidz state (dari quran-ai/tahfidz/page.tsx)
  ...
  // Tahsin state (dari quran-ai/tahsin/page.tsx)
  ...
  // Refs untuk tahsin (real-time per kata)
  ...
  // ── useQuranRecorder — pilih handler berdasarkan mode ──────────────
  ...
  // ── Audio untuk Tahsin (dengerin dulu) ────────────────────────────
  const playAudio = () => {
    if (audioRef.current) {
