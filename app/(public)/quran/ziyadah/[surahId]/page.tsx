...
export default async function ZiyadahPage({ params, searchParams }: Props) {
  ...
  return <QuranPracticeClient mode="ziyadah" chapter={chapter} verses={verses} ayahStart={start} ayahEnd={end} />
}
