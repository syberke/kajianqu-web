...
export default async function MurojaahPage({ params, searchParams }: Props) {
  ...
  return <QuranPracticeClient mode="murojaah" chapter={chapter} verses={verses} ayahStart={start} ayahEnd={end} />
}
