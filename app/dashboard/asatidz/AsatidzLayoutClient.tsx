...
function SidebarItem({ icon, label, href, active, badge }: {
  ...
  return (
    <Link href={href}>
      <div className={`flex items-center justify-between px-6 py-4 rounded-2xl cursor-pointer transition-all ${active ? 'bg-[#064E3B] text-white shadow-lg' : 'text-gray-400 hover:bg-gray-50 hover:text-emerald-900'}`}>
