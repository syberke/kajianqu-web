    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center p-8">
        <div className="max-w-md text-center space-y-6">
          ...
          <p className="text-[#313957] text-lg">Silakan cek email untuk verifikasi akun kamu.</p>
      ...
      <div className="flex-1 flex items-center justify-center p-8 lg:p-16">
        <div className="w-full max-w-[480px] space-y-8">
          <div className="space-y-3">
            <h1 className="text-4xl font-['Poppins',sans-serif] font-semibold text-[#0c1421] tracking-tight">Daftar Akun 📝</h1>
            <p className="text-[#313957] text-xl font-['Poppins',sans-serif]">Mulai perjalanan belajar Islam bersama KajianQu</p>
          </div>
          ...
          <button className="w-full flex items-center justify-center gap-4 bg-[#effffe] border border-[#d4d7e3] rounded-xl py-3 hover:bg-[#e0faf9] transition-colors">
            ...
            <span className="text-[#313957] text-base font-['Roboto',sans-serif]">Sign up with Google</span>
          </button>
